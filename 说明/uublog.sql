...
--
-- Host: 127.0.0.1    Database: uublog
-- ------------------------------------------------------
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$10000$RQkItPnH8YaA$L3sSVZ9fx3IiB+tURKAu2V//cysI0DgvtbfNhUfZpwg=','2013-06-21 06:14:25',1,'admin','','','admin@uublog.me',1,1,'2013-06-21 06:14:25'),(2,'pbkdf2_sha256$10000$0mUKHTw3HM9E$tDna0fE8Wi+kEzq9J0UTnuNqv9ZP4ZFIZqtH0BD/oc4=','2013-06-22 04:30:30',0,'uublog','uublog','','uublog@sina.com',0,1,'2013-06-21 06:47:08'),(3,'pbkdf2_sha256$24000$8m6FECcHA9NL$mgcwyqIW4MQK9SZxCP6ErTzPWWPZaiLn+Y59w2wft1A=','2017-05-16 10:35:53',0,'XinXinyi','XinXinyi','','123456@qq.com',0,1,'2017-05-16 10:35:26');
...
INSERT INTO `django_content_type` VALUES (1,'permission','auth','permission'),(2,'group','auth','group'),(3,'user','auth','user'),(4,'content type','contenttypes','contenttype'),(5,'session','sessions','session'),(6,'site','sites','site'),(7,'log entry','admin','logentry'),(8,'poll','polls','poll'),(9,'choice','polls','choice'),(10,'category','UUBlog','category'),(11,'article','UUBlog','article'),(12,'comment','UUBlog','comment'),(13,'user profile','UUBlog','userprofile'),(14,'blog','UUBlog','blog');
...
INSERT INTO `django_session` VALUES ('ny7umb9j35xpqg95rec7ni4o0unjcvb4','NTM5MjY1MzQ0YjQ4ZGRjOTkzMTBiYjRkNDVhM2ZkNTQ0YmQ2MDY4NzqAAn1xAShVEl9hdXRoX3VzZXJfYmFja2VuZHECVSlkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZHEDVQ1fYXV0aF91c2VyX2lkcQSKAQJ1Lg==','2013-07-05 16:03:18'),('upcj5ro8opsh6mgsw5ieqwrat9qc8ybe','NTM5MjY1MzQ0YjQ4ZGRjOTkzMTBiYjRkNDVhM2ZkNTQ0YmQ2MDY4NzqAAn1xAShVEl9hdXRoX3VzZXJfYmFja2VuZHECVSlkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZHEDVQ1fYXV0aF91c2VyX2lkcQSKAQJ1Lg==','2013-07-06 04:30:30');
...
--
-- Table structure for table `uublog_article`
--

DROP TABLE IF EXISTS `uublog_article`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uublog_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `uublog_blog`
--

LOCK TABLES `uublog_blog` WRITE;
/*!40000 ALTER TABLE `uublog_blog` DISABLE KEYS */;
INSERT INTO `uublog_blog` VALUES (1,1,'','admin的博客','','','','','profile,hotarticlelist,hotcommentlist','default','','','',3,3,0,0,'2013-06-21 06:34:56'),(2,2,'','uublog的博客','','','','','profile,category,hotcommentlist,hotarticlelist','default','','','',68,68,11,2,'2013-06-21 06:47:09'),(3,3,'','XinXinyi的微博','','','','','profile,hotarticlelist,hotcommentlist','default','','','',3,3,0,0,'2017-05-16 10:35:26');
/*!40000 ALTER TABLE `uublog_blog` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `uublog_category`
--

DROP TABLE IF EXISTS `uublog_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uublog_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(80) NOT NULL,
...
--
-- Dumping data for table `uublog_category`
--

LOCK TABLES `uublog_category` WRITE;
/*!40000 ALTER TABLE `uublog_category` DISABLE KEYS */;
INSERT INTO `uublog_category` VALUES (1,'未分类',-1,-1,-1),(2,'明星',1,11,2);
/*!40000 ALTER TABLE `uublog_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `uublog_channel`
--

DROP TABLE IF EXISTS `uublog_channel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uublog_channel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `uublog_channel`
--

LOCK TABLES `uublog_channel` WRITE;
/*!40000 ALTER TABLE `uublog_channel` DISABLE KEYS */;
INSERT INTO `uublog_channel` VALUES (1,0,'摄影',0,2,0,0,'',1),(2,0,'旅游',0,0,0,0,'',1),(3,0,'美食',0,2,0,0,'',1),(4,0,'宠物',0,0,0,0,'',1),(5,0,'家居',0,0,0,0,'',1),(6,0,'时尚',0,0,0,0,'',1),(7,0,'文学',0,0,0,0,'',1),(8,0,'艺术',0,0,0,0,'',1),(9,0,'创意',0,0,0,0,'',1),(10,0,'影视',0,0,0,0,'',1),(11,0,'美女',0,0,0,0,'',1),(12,0,'音乐',0,0,0,0,'',1),(13,0,'游戏',0,0,0,0,'',1),(14,0,'动漫',0,0,0,0,'',1),(15,0,'搞笑',0,0,0,0,'',1),(16,0,'星座',0,0,0,0,'',1),(17,0,'恋物',0,0,0,0,'',1),(18,0,'体育',0,0,0,0,'',1),(19,0,'数码',0,0,0,0,'',1),(20,0,'科学',0,0,0,0,'',1),(21,0,'育儿',0,0,0,0,'',1),(22,0,'心情',0,0,0,0,'',1),(23,0,'自然',0,0,0,0,'',1),(24,0,'插画',0,0,0,0,'',1),(25,0,'明星',0,0,0,0,'',1),(26,0,'资讯',0,0,0,0,'',1),(27,0,'生活',0,0,0,0,'',1);
/*!40000 ALTER TABLE `uublog_channel` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `uublog_comment`
--

DROP TABLE IF EXISTS `uublog_comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uublog_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `article_id_refs_id_ec096e86` FOREIGN KEY (`article_id`) REFERENCES `uublog_article` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=gbk;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `uublog_comment`
--

LOCK TABLES `uublog_comment` WRITE;
/*!40000 ALTER TABLE `uublog_comment` DISABLE KEYS */;
INSERT INTO `uublog_comment` VALUES (1,1,2,'uublog','asdfafds','2013-06-21 09:38:51',0,0,0),(2,9,2,'uublog','残酷的竞争中杀出一条血路。\r\n　　中国内互联网企业的厮杀也异常激烈，大企业瞬间复制模仿你，秒杀你，2004年9月，QQ游戏平台将联众赶下了中国第一休闲游戏门户的宝座。我记得那个时候室友还在上面玩游戏，现在联众早已被网民遗忘，以至于记得当时的新闻是，\"多年以后，在北京知春路的一家咖啡馆，联众创始人鲍岳桥谈起当年腾讯对联众的围剿和逼迫，仍然耿耿于怀。在两个小时的采访中，他连续抽了两包烟\"。20','2013-06-22 05:24:02',0,0,0);
/*!40000 ALTER TABLE `uublog_comment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `uublog_great`
--

DROP TABLE IF EXISTS `uublog_great`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uublog_great` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `article_id` int(11) NOT NULL,
...
--
-- Dumping data for table `uublog_great`
--

LOCK TABLES `uublog_great` WRITE;
/*!40000 ALTER TABLE `uublog_great` DISABLE KEYS */;
/*!40000 ALTER TABLE `uublog_great` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `uublog_relation`
--

DROP TABLE IF EXISTS `uublog_relation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uublog_relation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `uublog_relation`
--

LOCK TABLES `uublog_relation` WRITE;
/*!40000 ALTER TABLE `uublog_relation` DISABLE KEYS */;
/*!40000 ALTER TABLE `uublog_relation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `uublog_userprofile`
--

DROP TABLE IF EXISTS `uublog_userprofile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uublog_userprofile` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  ...
  CONSTRAINT `user_id_refs_id_3acc5dbb` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=gbk;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `uublog_userprofile`
--

LOCK TABLES `uublog_userprofile` WRITE;
/*!40000 ALTER TABLE `uublog_userprofile` DISABLE KEYS */;
INSERT INTO `uublog_userprofile` VALUES (1,1,'','admin','',0,'2013-06-21 06:23:14','','',0,0,0,'','','','','','','','','','','','',''),(2,2,'avatar/000/00/02.gif','uublog','',0,'2013-06-21 06:23:14','','',0,0,0,'','','','','','','','','','','','',''),(3,3,'','XinXinyi','',0,'2017-05-16 10:34:34','','',0,0,0,'','','','','','','','','','','','','');
/*!40000 ALTER TABLE `uublog_userprofile` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-05-16 20:03:06
